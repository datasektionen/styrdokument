...
Datasektionen har även egna dokument. För att reglera vår egen verksamhet har vi våra stadgar och vårat reglemente. Kassören är ansvarig för sektionens ekonomirutiner – dessa finner du i PM för ekonomi. Sen har vi en drös med policydokument och PM som beskriver hur specifika delar av vår verksamhet ska skötas, till exempel rekrytering i rekryteringspolicyn. Alla dokument utöver stadgar, reglemente och PM listas under §[2](./reglemente#2-andra-styrande-dokument) i reglementet. En kort beskrivning av vad varje dokument innebär, inklusive stadgar, reglemente och PM, finner ni nedan:
...
- [**Policyer**](./policies)
    ...
    - [**Rekryteringspolicy**](./policies/rekryteringspolicy): Här står skrivet hur inval och rekrytering till diverse interna grupper ska ske. En längre beskrivning står med i toppen av policyn.
    - [**Samarbetspolicy**](./policies/samarbetspolicy): Här regleras våra samarbeten med andra företag och organisationer. En längre beskrivning står med i toppen av policyn.
...
- [**PM (Promemoria)**](./pm)
    ...
    - [**PM för partitioner**](./pm/pm_partitioner): Här regleras våra partitioner (som fungerar som klubbar). Alla aktiva partitioner listas även här.
    - [**PM för stipendier**](./pm/pm_stipendier): Här regleras de stipendier som vi delar ut.
    - [**PM för traditioner, vanor, och livsregler**](./pm/pm_traditioner): Här listas våra traditioner, vanor, och livsregler. Det är mer kul läsning än något annat.
- [**Övriga dokument**](./ovrigt): Utöver dokumenten ovan finns det några övriga styrande dokument, såsom vår budget. De går att läsa mer om på länken till vänster.
