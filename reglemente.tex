...
\subsection{Styrelsemedalj}

\subsubsection{Syfte}

Styrelsemedaljen delas ut till de sektionsmedlemmar som under en hel mandatperiod tjänstgjort i D-rektoratet.

\subsubsection{Utdelning}

Endast en medalj per person och år, oavsett antal styrelseposter personen besuttit.
Ordförande ansvarar för att medaljen delas ut på Vårbalen eller motsvarande högtidligt tillfälle samma år.
