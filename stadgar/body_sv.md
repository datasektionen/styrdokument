...
VM är beslutsmässigt när mötet är behörigt utlyst enligt §[5.2] och minst 2δ +1, där δ är antalet ledamötposter i styrelsen, eller 15 om δ är mindre än 7, sektionsmedlemmar är närvarande.
...
# §4.4 Ordinarie val
Nomineringslistan ska anslås enligt §[4.3] senast 35 dagar före ett valtillfälle då ordinarie val sker. Nominering till funktionärspost måste lämnas in senast 21 dagar före det valtillfälle då valet sker. Nominering till funktionärspost måste accepteras sedan 14 dagar före det valtillfälle då valet sker för att kandidaturen ska vara giltig. Vidare reglering av ordinarie val vid varje valtillfälle kan ske i enlighet med §[4.1].
